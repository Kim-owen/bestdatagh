...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GigMart — Ghana's Cheapest MTN, Telecel & AirtelTigo Data Bundles" },
      ...
      { property: "og:title", content: "GigMart — Ghana's Cheapest Data Bundles" },
      { property: "og:description", content: "Buy cheap MTN, Telecel & AirtelTigo data bundles in Ghana. Fast delivery, secure Paystack payments." },
